...
%----------------------------------------------------------------------------------------
%	ACADEMIC POSITIONS SECTION (placeholder)
%----------------------------------------------------------------------------------------
...
%	\textbf{University of California, Davis} \hfill \textit{June 2026} \\ 
%	M.A., Mathematics \\
...
\begin{rSection}{Talks}
	...
	\begin{enumerate}
		...
		\item \textit{CSU Putnam Club}, Colorado State University, Fort Collins, CO, September 2023 %Remove this at some point
		\begin{itemize}
